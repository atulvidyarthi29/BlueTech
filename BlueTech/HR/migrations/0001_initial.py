# Generated by Django 2.2.6 on 2019-12-11 16:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Resolved', 'Resolved')], max_length=200)),
                ('against', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='against', to='Users.Employee')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='by', to='Users.Employee')),
            ],
        ),
        migrations.CreateModel(
            name='Salary',
